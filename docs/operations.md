...
`bitmark-indexer` is centered on blockchain tooling work in Rust. The technical target is: Index block headers, chain scores, and reorg decisions.
...
The score is deterministic. The current threshold is 158. Risk has a penalty of 6, latency has a penalty of 3, and weight contributes a bonus of 6.
