"""Regression checks for the bitmark-indexer casebook."""
...
from casebook.harness import assert_expected, bitmark_indexer_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(bitmark_indexer_summary(), assert_expected())
